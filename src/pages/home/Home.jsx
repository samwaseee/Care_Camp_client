        ...
        <>
            ...
            >
                <div>
                    ...
                    <p className='max-w-2xl absolute bottom-0 left-1/4 bg-second p-10'>
                ...
                <div>
                    ...
                    <p className='max-w-2xl absolute bottom-0 left-1/4 bg-second p-10'>The IFRC, with the support of partners, works at the community, national and global levels to reduce people’s risk of contracting non-communicable diseases. Our approach promotes healthy choices and behaviours at all stages of a person’s life.</p>
                </div>
            </AutoplaySlider>
        </>
    );
